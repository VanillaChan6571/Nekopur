...
rem
rem Any setting can be given per server as NEKOPUR_<N>_<NAME> or shared as NEKOPUR_<NAME>. The per-server
rem form wins. Hosts, ports and users usually differ; passwords and remote directories usually do not.

set "SERVERS=2"
set "NEKOPUR_SFTP_ENABLED=1"

set "NEKOPUR_1_SFTP_HOST=node01.example.com"
set "NEKOPUR_1_SFTP_PORT=2022"
set "NEKOPUR_1_SFTP_USER=vanillachanny.nodeid"

set "NEKOPUR_2_SFTP_HOST=node02.example.com"
set "NEKOPUR_2_SFTP_PORT=2022"
set "NEKOPUR_2_SFTP_USER=vanillachanny.nodeid"

rem Shared across every server above.
set "NEKOPUR_SFTP_REMOTE_DIR=/"
...
set "NEKOPUR_SFTP_PASSWORD=your-panel-sftp-password"
set "NEKOPUR_WINSCP=C:\Program Files (x86)\WinSCP\WinSCP.com"

rem Key or agent auth, used whenever no password is set. Needs no WinSCP install.
rem set "NEKOPUR_SFTP_KEY=C:\Users\VanillaChanny\.ssh\id_ed25519"
