...
public class CraftInventoryAnvil extends CraftResultInventory implements AnvilInventory {
    ...
    public void setDoUnsafeEnchants(boolean canDoUnsafeEnchants) {
        if (this.getInventory() instanceof net.minecraft.world.inventory.AnvilMenu anvil) {
            anvil.canDoUnsafeEnchants = canDoUnsafeEnchants;
        }
    ...
    public boolean canDoUnsafeEnchants() {
        if (this.getInventory() instanceof net.minecraft.world.inventory.AnvilMenu anvil) {
            return anvil.canDoUnsafeEnchants;
        }
        return false;
    }
    ...
    public boolean canBypassCost() {
        if (this.getInventory() instanceof net.minecraft.world.inventory.AnvilMenu anvil) {
            return anvil.bypassEnchantmentLevelRestriction;
        }
        return false;
    }
    ...
    public void setBypassCost(boolean bypassCost) {
        if (this.getInventory() instanceof net.minecraft.world.inventory.AnvilMenu anvil) {
            anvil.bypassEnchantmentLevelRestriction = bypassCost;
        }
    }
